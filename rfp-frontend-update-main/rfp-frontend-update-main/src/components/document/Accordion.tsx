              ...
              !isQuesEditing ? (
                <div className="flex relative w-full">
                  <h1>{query}</h1>
                  {
                    ...
                    <div
                      className="absolute justify-end right-[-15px] top-[2px] bg-gray-50 hover:cursor-pointer z-20"
                      onClick={() => {
                ...
                {responses[i] ? (
                  <>
                    {!isEditing ? (
                      <>
                        <div
                          className="relative flex w-full rounded-xl border bg-gray-50"
                        ...
                        >
                          ...
                          {isHovered && (
                            <div
                              className="absolute right-[8px] top-[8px] bg-gray-50 hover:cursor-pointer"
                              onClick={() => {
                                setIsEditing(true);
                  ...
                  <>
                    <div className="loader h-4 w-4 rounded-full border-2 border-gray-50 ease-linear"></div>
