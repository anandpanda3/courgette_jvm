  ...
  return (
    ...
    >
      <div className="ml-3 flex w-1/2 items-center justify-start ">
        ...
        >
          {/* <div className="text font-bold">{file.filename}</div> */}
          <div className="ml-2 text-[14px] line-clamp-1">
            {" "}
            {file.filename}
          </div>
        </div>
        ...
        <div className="flex h-[30px] w-[350px] items-center justify-between">
          ...
          <div className="relative">
            <div className="mr-5 flex items-center justify-between ">
              ...
              {zoomPopoverOpen && (
                <div className="absolute right-[55px] top-[30px] z-20 mb-2 rounded border bg-white py-1 text-white shadow">
